 ...
 *
 */
async function accountsTransactions(stakeAddress, pagination, cursorPagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    const cursorPaginationParams = (0, utils_1.getCursorPaginationParams)(cursorPagination);
    try {
        const res = await this.instance(`accounts/${stakeAddress}/transactions`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
exports.accountsTransactions = accountsTransactions;
/**
 ...
 *
 */
async function accountsTransactionsAll(stakeAddress, allMethodOptions, cursorPagination) {
    return (0, utils_1.paginateMethod)((pagination, cursorPagination) => this.accountsTransactions(stakeAddress, pagination, cursorPagination), allMethodOptions, cursorPagination);
}
exports.accountsTransactionsAll = accountsTransactionsAll;
