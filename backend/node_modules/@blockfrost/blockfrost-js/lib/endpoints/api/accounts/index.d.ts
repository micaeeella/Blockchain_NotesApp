...
import { AllMethodOptions, CursorPaginationOptions, PaginationOptions } from '../../../types';
/**
 ...
 *
 */
export declare function accountsTransactions(this: BlockFrostAPI, stakeAddress: string, pagination?: PaginationOptions, cursorPagination?: CursorPaginationOptions): Promise<components['schemas']['account_transactions_content']>;
/**
 ...
 *
 */
export declare function accountsTransactionsAll(this: BlockFrostAPI, stakeAddress: string, allMethodOptions?: AllMethodOptions, cursorPagination?: CursorPaginationOptions): Promise<components['schemas']['account_transactions_content']>;
