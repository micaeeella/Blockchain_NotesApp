 ...
 *
 */
async function addressesTransactions(address, pagination, cursorPagination) {
 ...
 *
 */
async function addressesTransactionsAll(address, allMethodOptions, cursorPagination) {
    return (0, utils_1.paginateMethod)((pagination, cursorPagination) => this.addressesTransactions(address, pagination, cursorPagination), allMethodOptions, cursorPagination);
}
