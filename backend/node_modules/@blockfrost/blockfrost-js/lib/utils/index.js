...
exports.paginateMethod = exports.getAllMethodOptions = exports.getPaginationOptions = exports.getCursorPaginationParams = exports.validateOptions = exports.isDebugEnabled = void 0;
...
const getCursorPaginationParams = (options) => {
    if (!options) {
        return {
            from: undefined,
            to: undefined,
...
exports.getCursorPaginationParams = getCursorPaginationParams;
...
const paginateMethod = async (fn, allMethodOptions, cursorPagination) => {
    const res = [];
    let page = 1;
